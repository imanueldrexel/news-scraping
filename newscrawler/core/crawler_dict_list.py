...
from newscrawler.infrastructure.datasource.scrapers.emitennews.emitennews_crawler import (
    EmitennewsCrawler,
)
...
from newscrawler.infrastructure.datasource.scrapers.inews.inews_crawler import (
    INewsCrawler,
)
from newscrawler.infrastructure.datasource.scrapers.detik.detik_crawler import (
    DetikCrawler,
)
from newscrawler.infrastructure.datasource.scrapers.era_id.eraid_crawler import (
    EraIDCrawler,
)
from newscrawler.infrastructure.datasource.scrapers.idntimes.idntimes_crawler import (
    IDNTimesCrawler,
)
...
from newscrawler.infrastructure.datasource.scrapers.kumparan.kumparan_crawler import (
    KumparanCrawler,
)
...
from newscrawler.infrastructure.datasource.scrapers.merdeka.merdeka_crawler import (
    MerdekaCrawler,
)
from newscrawler.infrastructure.datasource.scrapers.okezone.okezone_crawler import (
    OkezoneCrawler,
)
...
from newscrawler.infrastructure.datasource.scrapers.tvonenews.tvonenews_crawler import (
    TVOneNewsCrawler,
)
from newscrawler.infrastructure.datasource.scrapers.viva.viva_crawler import VivaCrawler
from newscrawler.infrastructure.datasource.scrapers.warta_ekonomi.warta_ekonomi_crawler import (
    WartaEkonomiCrawler,
)
